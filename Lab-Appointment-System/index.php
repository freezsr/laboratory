<?php
include_once('las/include/config.php');
...
<body>
    ...
    <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">E-Lab
                    ...
                    <div class="col-sm-2 d-none d-lg-block appoint">
                        <a class="btn btn-success" href="las/user-login.php">Book an Appointment</a>
                    </div>
                </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item ">
                    <img class="d-block w-100" src="assets/images/slider/slider3.png" alt="Second slide">
                </div>

                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/slider/slider1.png" alt="Third slide">
                </div>
                ...
                <div class="row no-margin">
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Patient Login</h6>
                                <a href="las/user-login.php" target="_blank">
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Doctors login</h6>
                                <a href="las/doctor" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                ...
                                <a href="las/admin" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
    ...
    <section id="contact_us" class="contact-us-single"><br>
        <div class="container">
            <div class="inner-title">
    ...
    <div>
        ...
        <footer class="text-center text-white" style="background-color: gray">
            ...
            <div class="container">
                ...
                <section class="mb-5">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <p>
                                We're committed to revolutionizing the healthcare experience by offering a seamless and convenient way to schedule lab appointments. With a focus on efficiency and patient care.
                            </p>
                        </div>
                    </div>
                </section>
            ...
            <!-- Copyright -->
            <div class="text-center p-3" style="background-color: #5A5A5A">
                © 2024 Copyright:
                <a class="text-white" href="https://labappointment.com/">Lab Appointment System</a>
            </div>
            <!-- Copyright -->
        </footer>
        <!-- Footer -->
